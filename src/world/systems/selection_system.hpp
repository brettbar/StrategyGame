...
namespace Selection {
  ...
  struct System {
    ...
    static void Draw( TextureCache &cache, bool isDebug ) {
      auto provsView =
    ...
    static void CheckSelectActors( vec2f click_pos, std::string player_id ) {
    ...
    static void CheckSelectProvince( vec2f click_pos, std::string player_id ) {
    ...
    static entt::entity CheckClickOnSettlement(
